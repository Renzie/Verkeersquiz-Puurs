...
CREATE TABLE `answer_user` (
  ...
  CONSTRAINT `Question` FOREIGN KEY (`QuestionId`) REFERENCES `question` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `login` VALUES (0,'art','123456');
...
CREATE TABLE `question` (
  ...
  CONSTRAINT `difficulty` FOREIGN KEY (`Difficulty`) REFERENCES `difficulty` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'Arthur','Saprunov',1),(2,'Renzie','Omaña',1),(3,'Maxime','Mylle',1);
...
-- Dump completed on 2017-10-25 14:54:11
