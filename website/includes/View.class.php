...
class View extends UserTools
{
    ...
    public function getAllSchools()
    {
        foreach ($this->getAllOrganization() as $school) {
            ...
            <tr class="school" schoolId="<?php echo $school["id"] ?>">
                <td><input class="schoolName" type="text" value="<?php echo $school["name"] ?>"
                           schoolIdName="<?php echo $school["id"] ?>"></td>
                <td><input class="schoolInfo" type="text" value="<?php echo $school["extraInfo"] ?>"
                           schoolIdInfo="<?php echo $school["id"] ?>"></td>
                <td><a class="btn red remove_school" buttonAction="deleteOrganization"><i
                            class="material-icons">delete</i></a>
                    <a class="btn purple save_school" buttonAction="updateOrganization"><i
    ...
    public function getQuizzes()
    {
        ...
        foreach ($this->getAllQuizzes() as $quiz) {
            ...
            <tr class="quiz" quizId="<?php echo $quiz["id"] ?>">
                <td><input class="quizName" type="text" value="<?php echo $quiz["name"] ?>"
                           schoolIdName="<?php echo $quiz["id"] ?>"></td>
                <td><input class="quizInfo" type="text" value="<?php echo $quiz["extraInfo"] ?>"
                           schoolIdInfo="<?php echo $quiz["id"] ?>"></td>
                <td>
                    <a href="editquestions.php?id=<?php echo $quiz["id"] ?>" class="btn edit_questions"><i
    ...
    public function showEditDifficulties()
    {
        ...
        foreach ($this->getAllDifficulties() as $difficulty) {
            ...
            <tr class="difficulty" diffId="<?php echo $difficulty["id"] ?>">
                ...
                <td><a class="btn red deleteDifficulty" buttonAction="deleteDifficulty"><i
                            class="material-icons">delete</i></a>
                    <a class="btn purple save_diff" buttonAction="updateDifficulty"><i
                            class="material-icons">save</i></a>''
                </td>
            </tr>
            <?php
        ...
        foreach ($this->getAllQuestionsByQuizId($id) as $data) {
            ...
            <li class="question" questionId="<?php echo $data["id"] ?>">
                ...
                <div class="collapsible-body">
                    <label>Vraag</label>
                    <input name="question" class="col s6" type="text" value="<?php echo $data["question"] ?>"
                           placeholder="vraag"/>
                    ...
                    <div class="editquestion row">
                        ...
                        <div class="col s4 file-field ">
                            <div>
                                ...
                                <img name="image" class="materialboxed questionimg"
                                     src="<?php echo($data["imageLink"] != "" ? "images/" . $data["imageLink"] : "#") ?>">
                            </div>
                        ...
                        <div class="questionbuttons col s3 file-field input-field">
                            <a data-tooltip="Voeg een foto toe"
                               class=" btn tooltipped btn-small waves-effect waves-light purple">
                                <i class="material-icons">add_a_photo</i> <input class="imageupload" type="file"
                    ...
                    <div class="row">
                        <div class="col s6">
                            <a class="newanswer  btn btn-small waves-effect waves-light blue "><i
    ...
    private function getAnswerByQuestionId($id)
    {
        ...
        foreach ($this->getAllAnswersByQuestionId($id) as $data) {
            ?>
            <li class="answer" answerid="<?php echo $data["id"] ?>" correct="<?php echo $data["correct"] ?>">
    ...
    public function amountQuestionsQuiz($id)
    {
        ...
        foreach ($this->getAllDifficulties() as $difficulty) {
            ...
            <div style="width:20%;display:inline-block;">
                <label><?php echo $difficulty["difficulty"] ?></label><input class="diff<?php echo $difficulty["id"] ?>"
